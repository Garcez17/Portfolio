...
export function SEO({
  ...
  const pageTitle = `${title} ${!shouldExcludeTitleSuffix ? '| Portfólio - Gabriel Garcez' : ''}`
  ...
  return (
    <Head>
      ...
      <meta name="twitter:site" content="@gssg000" />
      <meta name="twitter:creator" content="@gssg000" />
